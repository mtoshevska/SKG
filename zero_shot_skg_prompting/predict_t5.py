...
from dataset import ParallelTSTDatasetZSSKGT5
...
if __name__ == '__main__':
    ...
    train_dataset = ParallelTSTDatasetZSSKGT5(dataset_name=dataset_name,
                                              dataset_type='train',
                                              tokenizer_name=model_name,
                                              padding_size=max_length_map_maximum[dataset_name] + 30)
    val_dataset = ParallelTSTDatasetZSSKGT5(dataset_name=dataset_name,
                                            dataset_type='val',
                                            tokenizer_name=model_name,
                                            padding_size=max_length_map_maximum[dataset_name] + 30)
    test_dataset = ParallelTSTDatasetZSSKGT5(dataset_name=dataset_name,
                                             dataset_type='test',
                                             tokenizer_name=model_name,
                                             padding_size=max_length_map_maximum[dataset_name] + 30)
