...
from dataset import ParallelTSTDatasetZSSKGGPT
...
if __name__ == '__main__':
    ...
    train_dataset = ParallelTSTDatasetZSSKGGPT(dataset_name=dataset_name,
                                               dataset_type='train',
                                               tokenizer_name=model_name_map[model_name],
                                               padding_size=max_length_map_maximum[dataset_name] + 100)
    val_dataset = ParallelTSTDatasetZSSKGGPT(dataset_name=dataset_name,
                                             dataset_type='val',
                                             tokenizer_name=model_name_map[model_name],
                                             padding_size=max_length_map_maximum[dataset_name] + 100)
    test_dataset = ParallelTSTDatasetZSSKGGPT(dataset_name=dataset_name,
                                              dataset_type='test',
                                              tokenizer_name=model_name_map[model_name],
                                              padding_size=max_length_map_maximum[dataset_name] + 100)
