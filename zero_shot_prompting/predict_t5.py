...
from dataset import ParallelTSTDatasetZSPT5
...
if __name__ == '__main__':
    ...
    train_dataset = ParallelTSTDatasetZSPT5(dataset_name=dataset_name,
                                            dataset_type='train',
                                            tokenizer_name=model_name,
                                            padding_size=max_length_map_maximum[dataset_name] + 10)
    val_dataset = ParallelTSTDatasetZSPT5(dataset_name=dataset_name,
                                          dataset_type='val',
                                          tokenizer_name=model_name,
                                          padding_size=max_length_map_maximum[dataset_name] + 10)
    test_dataset = ParallelTSTDatasetZSPT5(dataset_name=dataset_name,
                                           dataset_type='test',
                                           tokenizer_name=model_name,
                                           padding_size=max_length_map_maximum[dataset_name] + 10)
