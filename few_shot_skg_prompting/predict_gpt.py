...
from dataset import ParallelTSTDatasetFSSKGGPT
...
if __name__ == '__main__':
    ...
    if 'clean' in dataset_name:
        ...
        train_dataset = ParallelTSTDatasetFSSKGGPT(dataset_name=dataset_name,
                                                   dataset_type='train',
                                                   tokenizer_name=model_name_map[model_name],
                                                   padding_size=max_length_map_maximum[dataset_name] * (
                                                           1 + n_few_shot) + 100,
                                                   n_few_shot=n_few_shot)
        val_dataset = ParallelTSTDatasetFSSKGGPT(dataset_name=dataset_name,
                                                 dataset_type='val',
                                                 tokenizer_name=model_name_map[model_name],
                                                 padding_size=max_length_map_maximum[dataset_name] * (
                                                         1 + n_few_shot) + 100,
    ...
    test_dataset = ParallelTSTDatasetFSSKGGPT(dataset_name=dataset_name,
                                              dataset_type='test',
                                              tokenizer_name=model_name_map[model_name],
                                              padding_size=max_length_map_maximum[dataset_name] * (
                                                      1 + n_few_shot) + 100,
